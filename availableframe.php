...
if(isset($_POST['savechanges'])){
		...
		$sql =("SELECT * FROM `order` WHERE name = '$name'") or die (mysqli_connect_error());
    $result=mysqli_query($con, $sql);
			...
			if(mysqli_num_rows($result)==5){
				...
				$sql = ("INSERT INTO `order` VALUES(NULL,'$name','$address','$contact','$id','$qty','new',NULL,'$otype','$datep')") or die (mysqli_connect_error());
        $result=mysqli_query($con, $sql);
							if($result==true){
